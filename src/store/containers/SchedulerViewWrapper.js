import SchedulerViewWrapper from "../../wrappers/SchedulerViewWrapper";
import { connect } from 'react-redux';

// Import the thunk functions that handle all of the interaction with the API
import { fetchSchedulerView } from "../middleware/thunk";
...
export default connect( mapStateToProps, { fetchSchedulerView } )( SchedulerViewWrapper );
